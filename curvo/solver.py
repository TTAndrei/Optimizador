...
class Solver:
    ...
    def paso(self):
        ...
        # `u` y `v` van en un solo lanzamiento de kernel: comparten matriz y
        # jerarquia -- los coeficientes salen de los flujos, de `nu_ef` y de que
        # caras son Dirichlet, no de su valor -- y el hilo que resuelve una linea
